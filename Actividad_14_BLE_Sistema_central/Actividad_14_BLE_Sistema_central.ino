...
//-----------------------Aca defino variables para mi programa--------------------------------
...
const int sensor_luz = A0;  //defino donde va conectado el sensor presencia
const int sensor_puerta = 2;  //defino pin donde va conectado el sensor magnetico

const int pin_buzzer = 12;  //defino donde va conectado el buzzer
const int pin_rele = 11;  //defino donde va conectado el buzzer

//----------------------------------------------------------------------------
//-----------------------Funcion Setup Principal--------------------------------
//----------------------------------------------------------------------------
...
void setup()
{
  ...
  pinMode(sensor_puerta, INPUT_PULLUP);  //defino sensor
  pinMode(pin_buzzer, OUTPUT);   //defino pin buzzer como salida
  pinMode(pin_rele, OUTPUT);   //defino pin led como salida
}
...
void loop()
{
  ...
  if (digitalRead(sensor_puerta) == HIGH)
  {
    ...
    lcd.setCursor(0, 1);
    lcd.print("    Intrusos    ");  //imprimo texto en fila inferior
  ...
  else
  {
    ...
    lcd.print("Sistema Domotico");   //imprimo texto en fila superior
    lcd.setCursor(0, 1);
    lcd.print("Sensor Luz=");   //imprimo texto en fila inferior
    lcd.print(valor);
    lcd.print("     "); 
